...
app.get('/', (req, res) => res.send('VIRU FM - INSTANT LOOP VOICE ACTIVE! 🛡️🔊🔥'));
...
function startStreaming() {
    ...
    console.log("--- [FINAL EMERGENCY MIX] VOICE LOOPING EVERY 2 SECONDS ---");
    ...
    const ffmpeg = spawn('ffmpeg', [
        ...
        // 🎤 VOICE LOOP: තත්පර 2න් 2ට ප්ලේ වෙනවා (adelay=2000). 
        // WhatsApp Opus Fix එකත් එක්ක Volume 40.0 කටම වැඩි කළා.
